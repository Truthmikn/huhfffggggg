...
$step = $data['adminStep'];
//$op = @$update['pts'];
$url = "https://truth--fwdcbfsb698136.codeanyapp.com/huhfffggggg/"; // آدرس پوشه ای که سورس داخلشه رو بزارید
$helper = "@Jjhgfjgbhbot"; // آیدی ربات هلپر همراه با @
$token = "5378394635:AAEE6Vu8S4wdTiMv-3prpUc439mJm6lPQd8" ;  // توکن ربات هلپر
if(!file_exists('ooo')){
